...
Private Sub Determine() 'determines how the window will respond
    Const kingcaesarID = &H2D551BDE 'used for protection
    Const requestedID = &H365C1A04 'real ID
    Const caesarsID = &H18E85F49
    Dim strRootPathName$
    ...
    #If CopyProtect Then '--------------------------
        ...
        If lngSerialNo = requestedID And strVolumeName = "FLOWCHART" And r = 1 Then
            AgathaChristie
            ...
            cmdButton_Click
        Else
            If lngSerialNo = kingcaesarID And strVolumeName = "DESIGN4" And r = 9 Then
                AgathaChristie
            End If
            ...
            If lngSerialNo = caesarsID And strVolumeName = "DESIGN3" And r = 4 Then
                AgathaChristie
            End If
        End If
    #Else '-------------------------
